...
def registerPage(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'an error occuredd')

    return render(request, 'base/login_registration.html', context={'form': form})
...
def updateRoom(request ,pk):
    ...
    if request.user != room.host:
        return HttpResponse("You are not allowed this")
